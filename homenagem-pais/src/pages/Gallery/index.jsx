...
const Gallery = () => {
  ...
  const fotosFamilia = [
    { id: 1, url: 'src/assets/painho&mainha.jpg', legenda: 'Momentos inesquecíveis juntos' },
    { id: 2, url: 'src/assets/painho&mainha2.jpg', legenda: 'Sua presença é o meu abrigo' },
    { id: 3, url: 'src/assets/painho&mainha3.jpg', legenda: 'Casal unido pelo amor' },
    { id: 4, url: 'src/assets/painho&mainha5.jpg', legenda: 'Sorrisos que alimentam a alma' },
    { id: 5, url: 'src/assets/painho&mainha6.jpg', legenda: 'Cada momento é um tesouro' },
    { id: 6, url: 'src/assets/painho&mainha7.jpg', legenda: 'Amor que transcende o tempo' },
